...
export const recommendedPlatforms = {
  ...
  poorService: {
    federal: {
      name: "Procuraduría Federal del Consumidor (Profeco)",
      url: "https://profecogob.com.mx/index.php/gob/profeco",
      minRequirements: ["Descripción de la queja", "Institución", "Servicio recibido"],
      avgTime: "10 días",
    },
    state: {
      name: "Ficalía General del Estado Q. Roo",
      url: "https://enlinea.fgeqroo.gob.mx/",
      minRequirements: ["Datos del denunciante", "Detalles de la queja", "Dependencia", "Fecha del hecho"],
      avgTime: "8 días",
    },
    municipal: {
      name: "Sistema de Recepción de Quejas y Denuncias de la Controlaria Municipal",
      url: "https://denunciacorrupcion.cancun.gob.mx/",
  ...
  information: {
    federal: {
      name: "Instituto Nacional de Transparencia, Acceso a la Información y Protección de Datos Personales (INAI)",
      url: "https://home.inai.org.mx/",
      minRequirements: ["Descripción clara", "Dependencia", "Temática"],
      avgTime: "20 días hábiles",
    },
    state: {
      name: "Instituto de Acceso a la Información Pública de Quintana Roo (IFAIP Q. Roo)",
      url: "http://www.idaipqroo.org.mx/",
      minRequirements: ["Especificar información", "Formato deseado"],
      avgTime: "15 días hábiles",
    },
    municipal: {
      name: "Municipio de Benito Juárez",
      url: "https://cancun.gob.mx/home",
